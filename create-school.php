...
$sql="INSERT INTO  tblschools(SchlName,Department) VALUES(:classname,:section)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Create Schook</title>
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- Information Scinces, Engeneering,Education etc</span>
                                                		</div>
                                                	</div>
                                                     <div class="form-group has-success">
