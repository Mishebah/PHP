...
$ret = "SELECT tblstudents.StudentName,tblschools.SchlName,tblschools.Department from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblschools on tblschools.id=tblstudents.ClassId where tblstudents.StudentId=:stid limit 1";
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Class</label>
                                                        <div class="col-sm-10">
<?php echo htmlentities($row->SchlName)?>(<?php echo htmlentities($row->Section)?>)
                                                        </div>
                                                    </div>
<div class="form-group">
