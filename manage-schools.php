...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->SchlName);?></td>
                                                            <td><?php echo htmlentities($result->Department);?></td>
                                                            <td><?php echo htmlentities($result->CreationDate);?></td>
<td>
<a href="edit-schools.php?classid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a>
