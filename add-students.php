...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,PhoneNumber,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:studentphone,:studentemail,:gender,:classid,:dob,:status)";
...
<div class="col-sm-10">
<input type="text" name="phoneNum" class="form-control" id="PhoneNo" required="required" autocomplete="off">
</div>
</div>
